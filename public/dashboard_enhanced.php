...
$pageTitle = "Dashboard";
$pageCSS = ["/assets/css/dashboard.css", "/assets/css/dashboard-enhanced.css"];
...
$profile_complete = !empty($user['phone']) && !empty($user['address']) && !empty($user['emergency_contact']);
?>
        ...
        <div class="card-body">
          <div class="info-grid">
            ...
            <div class="info-item">
              ...
              <div class="info-value"><?php echo $user['emergency_contact'] ? htmlspecialchars($user['emergency_contact']) : '<span class="text-muted">Not provided</span>'; ?></div>
            </div>
            <div class="info-item">
              <label>Address</label>
...
<!-- Additional modals for nutrition and goals would go here -->
