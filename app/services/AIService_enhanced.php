...
class AIService {
    ...
    private static function getHuggingFaceResponse($message, $user_context) {
        // Enhanced context for Hugging Face
        $context = "You are a helpful fitness assistant for L9 Fitness gym. Be professional, enthusiastic, and knowledgeable about fitness.";
        $fullMessage = $context . "\n\nUser: " . $message . "\nAssistant:";
